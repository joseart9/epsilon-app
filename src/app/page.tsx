...
export default function Home() {
  ...
  return (
    <div className='h-screen w-screen flex flex-col items-center justify-center space-y-3'>
      <div className='flex flex-col space-y-8 p-16 rounded-xl shadow-2xl items-center'>
        <h1 className='text-4xl mb-5'>Bienvenido a Epsilon</h1>
        <Input label='Empleado' value={inputValue} onChange={handleInputChange} type={isVisible ? "text" : "password"} endContent={
